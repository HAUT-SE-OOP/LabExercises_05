...
/* Write a header for an overloaded printArray function
   ...
   header */
template< typename T >
int printArray( int lowSubscript,int highSubscript,const T*array,int size) 
{
   
   // check if subscript is negative or out of range
   if ( /* Write conditions to test if the size if negative,
           or if the range is invalid */lowSubscript<0||highSubscript>size )
      return 0;   
   ...
   for ( /* Write code to iterate from lowSubscript up to
            and including highSubscript */ i=lowSubscript;i<=highSubscript;i++) 
   {
      ++count;
      cout << array[ i ] << ' ';
   } // end for
...
int main()
{
   ...
   elements = printArray(0,ACOUNT-1,a,5);/* Write a call to printArray that specifies 
   ...
   elements = printArray(1,3,a,5);/* Write a call to printArray that specifies 
                 1 to 3 as the range */
   cout << elements << " elements were output\n";

   // try to print an invalid element
   cout << "Array a output with invalid subscripts:\n";
   elements = printArray(-1,10,a,5);/* Write a call to printArray that specifies
   ...
   elements = printArray(0,BCOUNT-1,b,7);/* Write a call to printArray that specifies
                 0 to BCOUNT - 1 as the range */
   cout << elements << " elements were output\n";

   // display elements 1-3 of array b
   cout << "Array b from positions 1 to 3 is:\n";
   elements = printArray(1,3,b,7);/* Write a call to printArray that specifies
                 1 to 3 as the range */
   cout << elements << " elements were output\n";

   // try to print an invalid element
   cout << "Array b output with invalid subscripts:\n";
   elements = printArray(-1,10,b,7);/* Write a call to printArray that specifies
                 -1 to 10 as the range */
   cout << elements << " elements were output\n\n";
   ...
   elements = printArray(0,CCOUNT-2,c,6);/* Write a call to printArray that specifies
                 0 to CCOUNT - 2 as the range */
   cout << elements << " elements were output\n";

   // display elements 1-3 of array c
   cout << "Array c from positions 1 to 3 is:\n";
   elements = printArray(1,3,c,6);/* Write a call to printArray that specifies
                 1 to 3 as the range */
   cout << elements << " elements were output\n";

   // try to display an invalid element
   cout << "Array c output with invalid subscripts:\n";
   elements = printArray(-1,10,c,6);/* Write a call to printArray that specifies
                 -1 to 10 as the range */
