...
template< typename T >
int printArray(const T *array,int x,int low,int high)
{
...
int main()
{
   ...
   elements = printArray(c,6,0,4);/* Write a call to printArray that specifies
