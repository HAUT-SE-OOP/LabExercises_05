...
/* Write a header for an overloaded printArray function
   ...
   header */
template< typename T >
int printA( const T *array, int lowSubscrip, int highSubscript )
{
    int i = 1;
   // check if subscript is negative or out of range
   if ( lowSubscrip < 0 || highSubscript <= lowSubscrip
       /* Write conditions to test if the size if negative,
...
int main()
{
   ...
   elements = printA( a,1, 3 );/* Write a call to printArray that specifies
                 1 to 3 as the range */
   cout << elements << " elements were output\n";

   // try to print an invalid element
   cout << "Array a output with invalid subscripts:\n";
   elements = printA( a, -1, 10 );/* Write a call to printArray that specifies
   ...
   elements = printA( b ,0, 6 );/* Write a call to printArray that specifies
                 0 to BCOUNT - 1 as the range */
   cout << elements << " elements were output\n";

   // display elements 1-3 of array b
   cout << "Array b from positions 1 to 3 is:\n";
   elements = printA( b,1, 3 );/* Write a call to printArray that specifies
                 1 to 3 as the range */
   cout << elements << " elements were output\n";

   // try to print an invalid element
   cout << "Array b output with invalid subscripts:\n";
   elements = printA( b ,-1, 10 );/* Write a call to printArray that specifies
                 -1 to 10 as the range */
   cout << elements << " elements were output\n\n";
   ...
   elements = printA( c ,0, 4 );/* Write a call to printArray that specifies
                 0 to CCOUNT - 2 as the range */
   cout << elements << " elements were output\n";

   // display elements 1-3 of array c
   cout << "Array c from positions 1 to 3 is:\n";
   elements = printA( c ,1, 3 );/* Write a call to printArray that specifies
                 1 to 3 as the range */
   cout << elements << " elements were output\n";

   // try to display an invalid element
   cout << "Array c output with invalid subscripts:\n";
   elements = printA( c ,-1, 10 );/* Write a call to printArray that specifies
                 -1 to 10 as the range */
