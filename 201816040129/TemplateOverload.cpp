...
template< typename T >
double printArray(const T *array,int lowsubscript,int highSubscript)
   ...
   header */
{
   ...
   if (lowsubscript<0||highSubscript<=lowsubscript /* Write conditions to test if the size if negative,
