...
// takes upper and lower subscripts to print
   template< typename T >
   int printArray(const T *array, int number ,int lowSubscrip,int highSubscript)
{
   // check if subscript is negative or out of range
   if ( lowSubscrip<0||highSubscript>number )
      return 0;
