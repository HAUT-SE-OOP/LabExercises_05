...
template< typename T > T printArray( const T *array, int,int lowSubscrip,int highSubscript)
   ...
   header */
{
   ...
   if ( lowSubscrip<0||lowSubscrip>highSubscript/* Write conditions to test if the size if negative,
