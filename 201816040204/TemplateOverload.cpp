   ...
   header */
{
   ...
   if (  lowSubscript < 0 ||highSubscript >= Count ||lowSubscript > highSubscript/* Write conditions to test if the size if negative,
...
int main()
{
   ...
   elements = printArray (c, CCOUNT, 0, 6);/* Write a call to printArray that specifies
                 -1 to 10 as the range */
