...
template< typename T >
int printArray( const T *array, int lowSubscript, int highSubscript )
   ...
   header */
{
   ...
   if ( highSubscript < 0|| lowSubscript < 0||highSubscript < lowSubscript
...
int main()
{
   ...
   elements = printArray( c, 0, 2 );/* Write a call to printArray that specifies
