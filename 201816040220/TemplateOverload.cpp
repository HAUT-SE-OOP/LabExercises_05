...
template< typename T >
int printArray( const T *array, int x ,int lowSubscrip,int highSubscript)
   ...
   header */
{
   ...
   if ( lowSubscrip<0||highSubscript<=lowSubscrip||highSubscript>x
   ...
   // display array
   for (i=lowSubscrip;i<=highSubscript;i++ /* Write code to iterate from lowSubscript up to
