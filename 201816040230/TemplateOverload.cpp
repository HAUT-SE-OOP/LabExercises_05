...
template< typename T >
int printArray(const T*array,int a,int lowSubscrip, int highSubscript)
   ...
   header */
{
   ...
   if (highSubscript>a||highSubscript<=lowSubscrip )/* Write conditions to test if the size if negative,
