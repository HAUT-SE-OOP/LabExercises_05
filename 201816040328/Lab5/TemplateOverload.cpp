...
int printArray(const T *array,int size,int lowSubscrip,int highSubscript)
{
   ...
   if ((lowSubscrip<0)||(highSubscript<0)|| (highSubscript>size))
    {
        //cout<<"nhuf";
        return 0;
    }
...
int main()
{
   ...
   elements = printArray(a,5,0,4);/* Write a call to printArray that specifies
                 0 to  4 as the range */
   ...
   elements = printArray(b,7,0,6);/* Write a call to printArray that specifies
   ...
   elements = printArray(c,6,0,-2);/* Write a call to printArray that specifies
