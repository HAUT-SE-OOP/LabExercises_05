...
template< typename T >
int printArray(const T *array,int lowsubscript,int highsubscript)/* Write a header for an overloaded printArray function
   ...
   header */
{
   ...
   if ( highsubscript<lowsubscript||highsubscript<0||lowsubscript<0/* Write conditions to test if the size if negative,
